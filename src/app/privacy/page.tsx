    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Pool Scores, the software
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Pool Scores.
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>By email: <a className="underline" href="mailto:poolscoresapp@gmail.com">poolscoresapp@gmail.com</a></li>
        </ul>
      </main>
    </div>
  );
